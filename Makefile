...
k8s: vendor/k8s.io/code-generator
	vendor/k8s.io/code-generator/generate-groups.sh all github.com/domeos/k8s-ipam/pkg/client github.com/domeos/k8s-ipam/pkg/api "k8s.domeos.sohuno.com:v1alpha1"
