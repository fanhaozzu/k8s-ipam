...
import (
	...
	"net"
	"strings"
	bv "github.com/domeos/k8s-ipam/pkg/utils/buildversion"
...
func cmdDel(args *skel.CmdArgs) error {
	...
	if freeErr != nil {
		return fmt.Errorf("unable to get allocation for pod: %v", freeErr)
	}
...
func main() {
	skel.PluginMain(cmdAdd, cmdCheck, cmdDel, version.All, bv.BuildString("k8s-ipam"))
}
